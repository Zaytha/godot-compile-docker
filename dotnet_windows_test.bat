...
@REM echo ---------------------------------- [3/4] Starting Linux Build ---------------------------------
@REM REM run the dockerfile for linux build
@REM docker-compose up --build --abort-on-container-exit --exit-code-from linux_build linux_build
@REM echo -------------------------------------- Linux Build Finished -------------------------------------
...
REM Build Binaries
scons platform=windows tools=yes target=editor module_mono_enabled=yes
REM Build Templates
scons platform=windows tools=no target=template_debug module_mono_enabled=yes
scons platform=windows tools=no target=template_release production=yes module_mono_enabled=yes
REM Genreate glue sources
